...
mejordescripcion VARCHAR2(250) NOT NULL,
mejorplazo date,
...
INSERT into mejora(mejortitulo,mejordescripcion,mejorplazo,asesoria_idasesoria) values ('demarcacion zona transito','establecer periodos para la pintura de señaletica',to_date('06/05/2021','DD/MM/YYYY'),'2');
INSERT into mejora(mejortitulo,mejordescripcion,mejorplazo,asesoria_idasesoria) values ('nueva señaletica','definir plazo de instalacion de nueva señaletica',to_date('06/05/2021','DD/MM/YYYY'),'2');
INSERT into mejora(mejortitulo,mejordescripcion,mejorplazo,asesoria_idasesoria) values ('capacitacion BPL','gestionar capacitacion con mutual',to_date('05/05/2021','DD/MM/YYYY'),'1');
